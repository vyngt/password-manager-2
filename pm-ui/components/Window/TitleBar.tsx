...
export function WindowTitleBar() {
  ...
  return (
    <header
      ...
      className="border-secondary flex h-10 flex-grow-0 justify-between border-b"
    >
      <div className="pointer-events-none flex flex-col justify-center pl-2">
        <div className="flex gap-2">
          ...
          <Typography variant="h5">VZen</Typography>
        </div>
      </div>
      <div
      ...
      <div className="flex h-full">
        ...
        <IconButton
          className="rounded-none hover:bg-red-400 hover:text-white"
          variant="text"
          onClick={async () => {
            const appWindow = await getAppWindow();
