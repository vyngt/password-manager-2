...
fn ComponentShowcase() -> impl IntoView {
    view! {
        <div class="rounded-lg border border-border bg-surface-1 p-4 space-y-4">
            <h3 class="text-sm font-semibold text-text-primary">"Components"</h3>

            // Buttons
            <div>
                <p class="text-xs text-text-tertiary mb-2">"Buttons"</p>
            ...
            // Icon Buttons
            <div>
                <p class="text-xs text-text-tertiary mb-2">"Icon Buttons"</p>
                <div class="flex flex-wrap gap-2">
            ...
            // Sizes
            <div>
                <p class="text-xs text-text-tertiary mb-2">"Sizes"</p>
            ...
            // States
            <div>
                <p class="text-xs text-text-tertiary mb-2">"States"</p>
                <div class="flex flex-wrap gap-2">
            ...
            // Text hierarchy
            <div>
                <p class="text-xs text-text-tertiary mb-2">"Text hierarchy"</p>
                <div class="space-y-1">
            ...
            // Surface layers — visual boxes only, token values shown in Derived Tokens
            <div>
                <p class="text-xs text-text-tertiary mb-2">"Surface layers"</p>
...
fn Playground() -> impl IntoView {
    ...
    // Get the tokens signal (RwSignal is Copy, unlike ThemeState)
