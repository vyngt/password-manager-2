...
use vedge_core::infra::data::sqlite::datasource::migration::ThemeMigrator;
...
const ENTITY_OUTPUT_PATH: &str = "../vedge-core/src/infra/data/sqlite/entities/theme";
...
async fn refresh(con: Arc<DataSourceConnection>) {
    ThemeMigrator::refresh(con.conn()).await.unwrap();
}
