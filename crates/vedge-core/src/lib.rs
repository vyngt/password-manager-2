...
pub use application::vault::use_cases::{
    ...
    create_tag, delete_tag, enroll_biometric, entries_by_domain,
    ...
    rename_tag, restore_entry, restore_from_history, restore_vault, revert_to_snapshot,
    reveal_totp, run_maintenance,
