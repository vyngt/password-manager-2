...
pub use application::vault::use_cases::{
    ...
    RecoverVaultInput, RecoveryOutcome, RestoreReport, RestoreVaultInput, RevertReport,
    RevertToSnapshotInput, SnapshotReport, UnlockVault, UnlockVaultInput, UpdateEntryInput,
    backup_vault, change_password, copy_field, copy_history_field, create_entry, create_snapshot,
    create_tag, delete_tag, enroll_biometric, entries_by_domain, entries_by_folder, entries_by_tag,
    ...
    place_text_on_clipboard, record_lock, recover_vault, rename_tag, restore_entry,
    restore_from_history, restore_vault, reveal_totp, revert_to_snapshot, run_maintenance,
