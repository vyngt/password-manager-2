...
pub use application::vault::use_cases::{
    ...
    CredentialStatus, DOCUMENT_SIZE_LIMIT_BYTES, DeleteVaultInput, DeleteVaultReport,
    EnrollRecoveryOutcome, ExportEmergencyKitInput, ExportEntriesInput, ExportFormat, ExportReport,
    FieldSelector, GetEntryInput, HistoryVersion, ImportDocumentInput, InspectBackupInput,
    MaintenanceReport, OpenBackupInput, OpenBackupReport, RekeyOutcome, RekeyReport,
    RekeyVaultInput, ReplaceReport, ReplaceVaultInput, RevealEnvVarsInput, RevealFieldInput,
    ...
    change_password, change_password_after_recovery, close_session_db, copy_env_vars, copy_field,
    copy_history_field, create_entry, create_snapshot, create_tag, credential_status, delete_tag,
    delete_vault, enroll_biometric, enroll_recovery_key, entries_by_domain, entries_by_folder,
    ...
    normalize_tag_name, open_backup, place_text_on_clipboard, reauthenticate_master_password,
    record_lock, rekey_vault, rename_tag, replace_vault_from_backup, restore_entry,
    restore_from_history, reveal_env_vars, reveal_field, reveal_history_field,
    reveal_recovery_codes, reveal_totp, revert_to_snapshot, revert_to_snapshot_in_session,
    revoke_recovery_key, run_maintenance, scan_health, search_entries, set_favorite,
