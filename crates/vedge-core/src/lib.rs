...
pub use application::vault::use_cases::{
    ...
    ReplaceVaultInput, RevertReport, RevertToSnapshotInput, SeamlessRevertOutcome, SnapshotReport,
    TargetStateKind, UnlockVault, UnlockVaultInput, UpdateEntryInput, backup_status, backup_vault,
    change_password, close_session_db, copy_field, copy_history_field, create_entry,
    create_snapshot, create_tag, delete_tag, enroll_biometric, entries_by_domain,
    ...
    move_entry, normalize_tag_name, open_backup, place_text_on_clipboard, record_lock,
    recover_vault, rename_tag, replace_vault_from_backup, restore_entry, restore_from_history,
    reveal_totp, revert_to_snapshot, revert_to_snapshot_in_session, run_maintenance, scan_health,
