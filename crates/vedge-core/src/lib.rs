...
pub use application::vault::use_cases::{
    AUDIT_PAGE_DEFAULT, AUDIT_PAGE_MAX, ChangePasswordInput, CopyFieldInput, CopyHistoryFieldInput,
    CreateEntryInput, CreateEntryOutput, CreateVault, CreateVaultInput, CreateVaultOutput,
    DOCUMENT_SIZE_LIMIT_BYTES, ExportEmergencyKitInput, FieldSelector, GetEntryInput,
    HistoryVersion, ImportDocumentInput, MaintenanceReport, RecoverVaultInput, RecoveryOutcome,
    UnlockVault, UnlockVaultInput, UpdateEntryInput, change_password, copy_field,
    copy_history_field, create_entry, create_tag, delete_tag, enroll_biometric, entries_by_domain,
    ...
    restore_from_history, reveal_totp, run_maintenance, scan_health, search_entries, set_favorite,
