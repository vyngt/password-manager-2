...
pub use application::app::use_cases::{
    ...
    record_vault_uuid, remove_recent_vault, remove_stale_recents, rename_recent_vault,
    resolve_active_theme, set_active_theme, set_app_setting, touch_extension_session_last_active,
...
pub use application::vault::use_cases::{
    ...
    OpenBackupInput, OpenBackupReport, RecoverVaultInput, RecoveryOutcome, ReplaceReport,
    ReplaceVaultInput, RevertReport, RevertToSnapshotInput, SnapshotReport, TargetStateKind,
    ...
    import_document, inspect_backup, list_active_entries, list_audit, list_history, list_tags,
    list_trashed_entries, lock_vault, migrate_vault_layout, move_entry, normalize_tag_name,
    ...
    revert_to_snapshot, run_maintenance, scan_health, search_entries, set_favorite, set_sort_order,
