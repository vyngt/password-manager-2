...
pub use application::vault::use_cases::{
    ...
    BackupVaultInput, ChangePasswordInput, CopyEnvVarsInput, CopyFieldInput, CopyHistoryFieldInput,
    CreateEntryInput, CreateEntryOutput, CreateVault, CreateVaultInput, CreateVaultOutput,
    DOCUMENT_SIZE_LIMIT_BYTES, DeleteVaultInput, DeleteVaultReport, EnrollRecoveryOutcome,
    ExportEmergencyKitInput, ExportEntriesInput, ExportFormat, ExportReport, FieldSelector,
    GetEntryInput, HistoryVersion, ImportDocumentInput, InspectBackupInput, MaintenanceReport,
    OpenBackupInput, OpenBackupReport, RekeyOutcome, RekeyReport, RekeyVaultInput, ReplaceReport,
    ReplaceVaultInput, RevealEnvVarsInput, RevealFieldInput, RevealHistoryFieldInput,
    RevealRecoveryCodesInput, RevertReport, RevertToSnapshotInput, SeamlessRevertOutcome,
    SecretKeyUnlockOutcome, SnapshotReport, TargetStateKind, UnlockVault, UnlockVaultInput,
    UnlockWithSecretKeyInput, UpdateEntryInput, backup_status, backup_vault, change_password,
    change_password_after_recovery, close_session_db, copy_env_vars, copy_field,
    copy_history_field, create_entry, create_snapshot, create_tag, delete_tag, delete_vault,
    enroll_biometric, enroll_recovery_key, entries_by_domain, entries_by_folder, entries_by_tag,
    export_document, export_emergency_kit, export_entries, get_entry, get_history_value,
    hard_delete_entry, import_document, inspect_backup, list_active_entries, list_audit,
    list_history, list_tags, list_trashed_entries, lock_vault, move_entry, normalize_tag_name,
    open_backup, place_text_on_clipboard, reauthenticate_master_password, record_lock, rekey_vault,
    ...
    revert_to_snapshot_in_session, revoke_recovery_key, run_maintenance, scan_health,
    search_entries, set_favorite, set_sort_order, set_tags, soft_delete_entry,
    unlock_with_secret_key, update_entry,
};
