...
pub use application::vault::use_cases::{
    ...
    HistoryVersion, ImportDocumentInput, InspectBackupInput, MaintenanceReport,
    MigrateVaultLayoutInput, MigrateVaultLayoutOutput, OpenBackupInput, OpenBackupReport,
    RecoverVaultInput, RecoveryOutcome, ReplaceReport, ReplaceVaultInput, RevertReport,
    ...
    list_history, list_tags, list_trashed_entries, lock_vault, migrate_vault_layout, move_entry,
    normalize_tag_name, open_backup, place_text_on_clipboard, record_lock, recover_vault,
    rename_tag, replace_vault_from_backup, restore_entry, restore_from_history, reveal_totp,
