...
pub use application::vault::use_cases::{
    ...
    DeleteVaultInput, DeleteVaultReport, ExportEmergencyKitInput, FieldSelector, GetEntryInput,
    HistoryVersion, ImportDocumentInput, InspectBackupInput, MaintenanceReport, OpenBackupInput,
    OpenBackupReport, RecoverVaultInput, RecoveryOutcome, ReplaceReport, ReplaceVaultInput,
    RevertReport, RevertToSnapshotInput, SeamlessRevertOutcome, SnapshotReport, TargetStateKind,
    UnlockVault, UnlockVaultInput, UpdateEntryInput, backup_status, backup_vault, change_password,
    close_session_db, copy_field, copy_history_field, create_entry, create_snapshot, create_tag,
    delete_tag, delete_vault, enroll_biometric, entries_by_domain, entries_by_folder,
    entries_by_tag, export_document, export_emergency_kit, get_entry, get_history_value,
    ...
    open_backup, place_text_on_clipboard, record_lock, recover_vault, rename_tag,
    replace_vault_from_backup, restore_entry, restore_from_history, reveal_totp,
    revert_to_snapshot, revert_to_snapshot_in_session, run_maintenance, scan_health,
    search_entries, set_favorite, set_sort_order, set_tags, soft_delete_entry, update_entry,
};
