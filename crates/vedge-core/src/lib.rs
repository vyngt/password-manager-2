...
pub use application::vault::use_cases::{
    ...
    InspectBackupInput, MaintenanceReport, RecoverVaultInput, RecoveryOutcome, RestoreReport,
    RestoreVaultInput, UnlockVault, UnlockVaultInput, UpdateEntryInput, backup_vault,
    change_password, copy_field, copy_history_field, create_entry, create_tag, delete_tag,
    ...
    lock_vault, move_entry, normalize_tag_name, place_text_on_clipboard, record_lock,
    recover_vault, rename_tag, restore_entry, restore_from_history, restore_vault, reveal_totp,
