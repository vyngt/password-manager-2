...
pub use application::vault::use_cases::{
    AUDIT_PAGE_DEFAULT, AUDIT_PAGE_MAX, BackupReport, BackupVaultInput, ChangePasswordInput,
    CopyFieldInput, CopyHistoryFieldInput, CreateEntryInput, CreateEntryOutput, CreateVault,
    CreateVaultInput, CreateVaultOutput, DOCUMENT_SIZE_LIMIT_BYTES, ExportEmergencyKitInput,
    FieldSelector, GetEntryInput, HistoryVersion, ImportDocumentInput, MaintenanceReport,
    RecoverVaultInput, RecoveryOutcome, UnlockVault, UnlockVaultInput, UpdateEntryInput,
    backup_vault, change_password, copy_field, copy_history_field, create_entry, create_tag,
    ...
    import_document, list_active_entries, list_audit, list_history, list_tags,
    list_trashed_entries, lock_vault, move_entry, normalize_tag_name, place_text_on_clipboard,
    record_lock, recover_vault, rename_tag, restore_entry, restore_from_history, reveal_totp,
