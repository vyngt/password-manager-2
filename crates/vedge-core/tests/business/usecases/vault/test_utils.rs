...
use vedge_core::business::domain::repositories::{ListVaultItemsOptions, VaultItemRepository};
use vedge_core::business::domain::services::VaultService;
use vedge_core::errors::AppResult;
use vedge_core::shared::pager::{PaginationInput, PaginationOutput};
use uuid::Uuid;
...
impl VaultItemRepository for MockVaultItemRepository {
    async fn list(&self, input: ListVaultItemsOptions) -> AppResult<PaginationOutput<VaultItem>> {
        ...
        let output = PaginationOutput {
            ...
            metadata: vedge_core::shared::pager::PaginationMetadata::calculate_pagination(
