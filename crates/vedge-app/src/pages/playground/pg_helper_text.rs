        ...
        <div class="p-6 max-w-4xl mx-auto space-y-6">
            ...
            <Section title="Status">
                <div class="space-y-3 max-w-md">
                    ...
                    <HelperText id="ht-error" status=Status::Error message=Signal::stored("Password is too short".to_string()) error_label=err />
                    <HelperText id="ht-success" status=Status::Success message=Signal::stored("Username is available".to_string()) success_label=suc />
                    <HelperText id="ht-warning" status=Status::Warning message=Signal::stored("This action cannot be undone".to_string()) warning_label=wrn />
                </div>
            </Section>
            ...
            <Section title="Label + Input + HelperText">
                <div class="space-y-4 max-w-md">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <HelperText id="ht-comp-error-msg" status=Status::Error message=Signal::stored("Please enter a valid email address".to_string()) error_label=err />
                    </div>
                    <div class="flex flex-col gap-1.5">
                        ...
                        <HelperText id="ht-comp-success-msg" status=Status::Success message=Signal::stored("Looks great!".to_string()) success_label=suc />
                    </div>
                </div>
            </Section>
        </div>
