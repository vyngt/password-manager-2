...
pub(crate) async fn call<I, O>(cmd: &str, args: &I) -> Result<O, ApiError>
where
    I: Serialize + ?Sized,
    O: DeserializeOwned,
{
...
pub(crate) async fn call_void<I>(cmd: &str, args: &I) -> Result<(), ApiError>
where
    I: Serialize + ?Sized,
{
...
pub(crate) async fn call_noargs<O>(cmd: &str) -> Result<O, ApiError>
where
    O: DeserializeOwned,
{
    #[derive(Serialize)]
