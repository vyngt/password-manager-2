...
//! copied". Determinate progress is deferred (no WASM↔Tauri event bridge yet); the dialog shows a
//! Spinner + "this may take a few minutes" and a Cancel that aborts before the commit point.
    ...
    let submit = move || {
        ...
        spawn_local(async move {
            ...
            match result {
                ...
                Ok(result) => {
                    // Re-keyed + LOCKED. If the SK was rotated, show it once first; otherwise go
                            ...
                            view! {
                                ...
                                <div class="flex justify-end">
                                    <Button
                                        ...
                                        size=Size::Sm
                                        attr:data-testid="rekey-continue"
