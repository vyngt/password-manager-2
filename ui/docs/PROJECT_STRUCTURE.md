...
│   └── password-manager/               # Password manager specific examples
├── docs/                               # Documentation
...
│   │   │   │   ├── mod.rs
│   │   │   │   ├── icon.rs
│   │   │   │   ├── pm.rs               # Password manager icons
│   │   │   │   ├── v_edge.rs           # V-Edge icons
│   │   │   │   └── vorpal.rs           # Vorpal icons
...
│   │   │   ├── mod.rs
│   │   │   ├── biometric_prompt/       # Biometric prompt
│   │   │   │   ├── mod.rs
│   │   │   │   └── biometric_prompt.rs
│   │   │   ├── two_factor_auth/        # 2FA
│   │   │   │   ├── mod.rs
...
│   │   │   │   ├── mod.rs
│   │   │   │   └── vault_lock.rs
│   │   │   └── master_key_setup/       # Master key setup
│   │   │       ├── mod.rs
│   │   │       └── master_key_setup.rs
│   │   │
│   │   ├── password_manager/           # Password manager specific
│   │   │   ├── mod.rs
...
│   │   │   ├── vault_record_form/      # Vault record form
│   │   │   │   ├── mod.rs
│   │   │   │   └── vault_record_form.rs
│   │   │   ├── ssh_key_form/           # SSH key form
│   │   │   │   ├── mod.rs
│   │   │   │   └── ssh_key_form.rs
│   │   │   ├── environment_form/       # Environment form
│   │   │   │   ├── mod.rs
│   │   │   │   └── environment_form.rs
│   │   │   ├── certificate_form/       # Certificate form
│   │   │   │   ├── mod.rs
│   │   │   │   └── certificate_form.rs
│   │   │   ├── vault_item_card/        # Vault item card
│   │   │   │   ├── mod.rs
│   │   │   │   └── vault_item_card.rs
│   │   │   ├── vault_item_list/        # Vault item list
│   │   │   │   ├── mod.rs
│   │   │   │   └── vault_item_list.rs
│   │   │   ├── vault_search/           # Vault search
│   │   │   │   ├── mod.rs
│   │   │   │   └── vault_search.rs
│   │   │   ├── vault_filter/           # Vault filter
│   │   │   │   ├── mod.rs
│   │   │   │   └── vault_filter.rs
...
│   │   │   │   ├── mod.rs
│   │   │   │   └── vault_backup.rs
│   │   │   ├── password_breach_alert/   # Breach alert
│   │   │   │   ├── mod.rs
│   │   │   │   └── password_breach_alert.rs
│   │   │   ├── weak_password_warning/   # Weak password warning
│   │   │   │   ├── mod.rs
│   │   │   │   └── weak_password_warning.rs
│   │   │   ├── duplicate_password_alert/ # Duplicate alert
│   │   │   │   ├── mod.rs
│   │   │   │   └── duplicate_password_alert.rs
│   │   │   ├── expired_password_alert/  # Expired alert
│   │   │   │   ├── mod.rs
│   │   │   │   └── expired_password_alert.rs
...
│       └── password_manager.rs         # Password manager types
│
├── tests/                              # Test files
...
- **Core**: Theme system, providers, utilities
...
### 4. **Password Manager Specific**

- Dedicated `password_manager/` section for domain-specific components
- Security-focused components in `security/` section
- Mobile-specific components in `mobile/` section
...
### Phase 2: Add Core Infrastructure
...
1. Add password manager specific components
2. Implement security components
